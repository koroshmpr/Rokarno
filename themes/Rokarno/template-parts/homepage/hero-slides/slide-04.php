...
<div class="swiper-slide bg-secondary">
    ...
    <div class="h-100 d-flex align-items-end flex-wrap">
        <div class="h-lg-75 h-100 col d-flex gap-lg-4 <?= $cur_lan == 'en' ? '' : 'flex-lg-row-reverse';?>">
            ...
            <div class="col-lg-8 px-5 px-lg-0 d-flex flex-column gap-5 justify-content-center col justify-content-lg-evenly">
                <h3 class="display-1 <?= $cur_lan == 'en' ? 'text-end' : 'text-start';?> fw-bold text-primary" data-aos="fade-right" data-aos-delay="700" data-aos-duration="800">
                    <?= $slide4['title'];?>
                </h3>
                <div class="d-lg-flex d-grid gap-lg-3 gap-4 <?= $cur_lan == 'en' ? '' : 'justify-content-lg-end';?> " data-aos="fade-right" data-aos-delay="800" data-aos-duration="800">
                    <?php
                    $categories = get_terms(array(
                        ...
                        'hide_empty' => true,
                        'exclude' => array(57 , 16 , 56), // Exclude the uncategorized category
                    ));
                    ...
                    if ($categories) {
                        foreach ($categories as $category) {
                            ...
                            <div class="product_card d-flex flex-column justify-content-center gap-lg-2 gap-1 h-auto bg-dark bg-opacity-10 p-1 p-lg-3">
                                <img src="<?= $category_image ?? ''; ?>" alt="<?= esc_html($category->name); ?>"
                                     class="mx-auto object-fit col-md-7 col-6 mt-lg-n5 mt-n3 ratio-1" style="width:100px;">
                                <div class="d-flex flex-column justify-content-between align-items-center">
                                    <p class="card-title text-white fs-6 mt-lg-3 mt-2 mb-0">
                        ...
                        echo __('محصولی یافت نشد', 'rokarno');
                    }
                    ?>
                </div>
            </div>
