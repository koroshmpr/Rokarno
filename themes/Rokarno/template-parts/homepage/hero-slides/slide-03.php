...
<div class="swiper-slide bg-secondary">
    <div class="d-flex flex-column justify-items-lg-between justify-content-end h-100 align-items-<?= $cur_lan == 'en' ? 'end' : 'start';?>">
        ...
        <div class="row w-100 mx-0 h-lg-50 h-100 gap-lg-4 justify-content-<?= $cur_lan == 'en' ? 'start' : 'end';?>">
            <div class="col-lg-4 px-0 h-35 order-last object-fit order-lg-<?= $cur_lan == 'en' ? 'first' : 'last';?>">
                <div class="animate-img bg-cover animate-img-y h-100" style="background: url('<?php echo $slide3['img_second']['url'] ?? ''; ?>') center center / cover;"></div>
            </div>
