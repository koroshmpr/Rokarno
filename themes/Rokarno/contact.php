...
<section class="bg-secondary">
    ...
    <div class="container py-5">
        <div class="row justify-content-center">
            <div class="row-cols-lg-2 row justify-content-center">
                <div class="p-4 row gap-3 justify-content-center">
                    <h2 class="text-primary fw-bold display-3 text-center" data-aos="fade-up" data-aos-duration="1000">
                        Address</h2>
                    <address class="display-3 text-dark text-opacity-75 mb-0 text-center" data-aos="fade-up"
                             data-aos-duration="1000">
                        <?= get_field('address', 'option'); ?>
                    </address>
                    <a class="bg-dark bg-opacity-10 col-auto bg-opacity-10 p-3 rounded-2 text-dark text-opacity-75 d-flex align-items-center gap-3"
                ...
                <div class="p-4 row gap-3 justify-content-center">
                    ...
                    <a class="bg-dark bg-opacity-10 col-auto bg-opacity-10 p-3 rounded-2 text-dark text-opacity-75 d-flex align-items-center gap-3"
                       href="tel:<?= get_field('phone_factory', 'option'); ?>">
                        Call Us!
                    </a>
                </div>
            </div>
            ...
            <!--                <a class="bg-white bg-opacity-10 p-3 rounded-2 text-white d-flex align-items-center gap-3" href="mailto:-->
